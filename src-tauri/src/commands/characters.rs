...
pub async fn create_character(
    ...
    state.characters().create(novel_id, name).await.map_err(|e| e.to_string())
}
...
#[tauri::command]
pub async fn get_character(state: State<'_, AppState>, id: i32) -> Result<Option<characters::Model>, String> {
    state.characters().find_by_id(id).await.map_err(|e| e.to_string())
}
...
pub async fn save_character(
    ...
    state.characters().update(id, params).await.map_err(|e| e.to_string())
}

#[tauri::command]
pub async fn delete_character(state: State<'_, AppState>, id: i32) -> Result<(), String> {
    state.characters().delete(id).await.map_err(|e| e.to_string())
}
